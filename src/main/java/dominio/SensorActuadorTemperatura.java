...
public class SensorActuadorTemperatura {
	 ...
	 * @param temperaturaObjetivo temperatura objetivo inicial
	 */
	public SensorActuadorTemperatura(Temperatura temperatura, Temperatura temperaturaObjetivo){
	 ...
	 * @param temperaturaObjetivo nueva temperatura objetivo
	 */
