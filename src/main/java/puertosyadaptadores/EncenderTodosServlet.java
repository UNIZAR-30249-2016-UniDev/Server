 ...
 */
@WebServlet(value = "/api/encender", name = "EncenderServlet")
public class EncenderTodosServlet extends HttpServlet {
	...
	private void handleRequest(HttpServletRequest req, HttpServletResponse resp) {
		...
		if (edificio != null && planta != null) {
			boolean ok = GestionaEspacio.encenderTodosEspacios(Integer.parseInt(edificio), Integer.parseInt(planta));
			if (ok) {
