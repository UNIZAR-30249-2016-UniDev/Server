 ...
 */
@WebServlet(value = "/api/apagar", name = "ApagarServlet")
public class ApagarTodosServlet extends HttpServlet {
	...
	private void handleRequest(HttpServletRequest req, HttpServletResponse resp) {
		...
		if (edificio != null && planta != null) {
			boolean ok = GestionaEspacio.apagarTodosEspacios(Integer.parseInt(edificio), Integer.parseInt(planta));
			if (ok) {
